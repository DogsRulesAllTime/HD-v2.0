...
<a class="dropdown-item" href="mailto:vlad@htmlbook.ru"><i class="fa fa-envelope-o " aria-hidden="true"></i> Отправить письмо</a>
      ...
      <td>14.03.2017</td>
      <td>Зобов П.А.</td>
      <td style="text-align:center;"><i class="fa fa-lightbulb-o fa-2x" aria-hidden="true" style="color: orange;">
      </td>
    </tr>
       <tr class="">
      <td>3</td>
  ...
  {  ?>
   ...
   <td><?php echo $row['tema']; ?></td>
    <td><?php echo date_create("$row[data_sozdania]")->Format('d.m.Y'); ?></td> <!-- //вывод даты форматирование. -->
   <td> <?php echo"$row[data_end]"; ?> </td>
<td>
<div class="dropdown">
<button class="btn btn-primary dropdown-toggle" type="button" id="about-us" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<div class="dropdown-menu" aria-labelledby="about-us">
<a class="dropdown-item" href="mailto:<?php echo "$row[surname]"; ?>">
<i class="fa fa-envelope-o " aria-hidden="true"></i> Отправить письмо</a>
   ...
   <?php
     if ("$row[status]"==1) {   //если статус 1 то заявка в обработке и выводиться значяек лампочки
       echo '<td style="text-align:center;"><i class="fa fa-lightbulb-o fa-2x" aria-hidden="true" style="color: orange;"></i></td>';
     }elseif ("$row[status]"==2) { //если статус 2 то заявка выполнена и выводиться значяек галочки
